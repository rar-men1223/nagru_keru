 ...
 * Char1のAIを管理する
 */
public class Char1AI extends CharAI {
	/**
	 * コンストラクタ
	 */
	public Char1AI(){
		...
		this.Inputlist.add(new Cont_Renkyaku());
		this.Inputlist.add(new Cont_Guard());
		this.Inputlist.add(new Cont_Jump_Attack());
		this.Inputlist.add(new Cont_Squat_H_Attack());
	...
	class Cont_Squat_H_Attack extends CharAIControlBase {
		
		public Cont_Squat_H_Attack(){
	...
	class Cont_Renkyaku extends CharAIControlBase {
		
		public Cont_Renkyaku(){
		...
		public void move(GameSceneBattle scene, CharBase myChar, CharBase enemyChar){
			...
			if(this.frames == 1){
				if(myChar.position.x < enemyChar.position.x){
					//左側にいる
					if(scene.keylog_CPU[1].keystatus[KEY_STATE.ID_LEFT_CPU1] == true &&
						scene.keylog_CPU[2].keystatus[KEY_STATE.ID_LEFT_CPU1] == true &&
						scene.keylog_CPU[3].keystatus[KEY_STATE.ID_LEFT_CPU1] == true &&
						scene.keylog_CPU[4].keystatus[KEY_STATE.ID_LEFT_CPU1] == true &&
						scene.keylog_CPU[5].keystatus[KEY_STATE.ID_LEFT_CPU1] == true &&
						scene.keylog_CPU[6].keystatus[KEY_STATE.ID_LEFT_CPU1] == true &&
						scene.keylog_CPU[7].keystatus[KEY_STATE.ID_LEFT_CPU1] == true &&
						scene.keylog_CPU[8].keystatus[KEY_STATE.ID_LEFT_CPU1] == true &&
						scene.keylog_CPU[9].keystatus[KEY_STATE.ID_LEFT_CPU1] == true &&
						scene.keylog_CPU[10].keystatus[KEY_STATE.ID_LEFT_CPU1] == true){
						...
						this.frames = this.finalFrame;
					}
				}else{
					//右側にいる
					if(scene.keylog_CPU[1].keystatus[KEY_STATE.ID_RIGHT_CPU1] == true &&
						scene.keylog_CPU[2].keystatus[KEY_STATE.ID_RIGHT_CPU1] == true &&
						scene.keylog_CPU[3].keystatus[KEY_STATE.ID_RIGHT_CPU1] == true &&
						scene.keylog_CPU[4].keystatus[KEY_STATE.ID_RIGHT_CPU1] == true &&
						scene.keylog_CPU[5].keystatus[KEY_STATE.ID_RIGHT_CPU1] == true &&
						scene.keylog_CPU[6].keystatus[KEY_STATE.ID_RIGHT_CPU1] == true &&
						scene.keylog_CPU[7].keystatus[KEY_STATE.ID_RIGHT_CPU1] == true &&
						scene.keylog_CPU[8].keystatus[KEY_STATE.ID_RIGHT_CPU1] == true &&
						scene.keylog_CPU[9].keystatus[KEY_STATE.ID_RIGHT_CPU1] == true &&
						scene.keylog_CPU[10].keystatus[KEY_STATE.ID_RIGHT_CPU1] == true){
			...
			if(myChar.framestaus == 40 && myChar.getCurrentAction().afterHit == true){
